  ...
  return (
    <div className="container mt-5">
      <div className="row g-4">
        <div className="col">
          <Info img={ethereumIcon}>A percentage of treasury assets are deployed to purchase strategic keys, wrapped keys & FT ecosystem assets. </Info>
        </div>
        <div className="col">
          <Info img={squidIcon}>Bonded assets such as WETH USDC & wrapped keys creates reserve asset backing FTW minted for stakers.</Info>
        </div>
        <div className="col">
          <Info img={coinIcon}>POK (protocol owned keys), POL, Fees & yield generated by the protocol + the friend tech airdrop are owned & governed pro-rata by keyholders & FTW holders with a view for future mechanisms for options to redeem both treasury & airdrop.</Info>
        </div>
      </div>
    </div>
  );
