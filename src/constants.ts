...
export const EPOCH_INTERVAL = 28800; // number of blocks per epoch? (two second blocks 8 hour epochs)
...
export const addresses: IAddresses = {
  ...
  8453: {
    SQUID_ADDRESS: "0x3347453Ced85bd288D783d85cDEC9b01Ab90f9D8", // base
    SSQUID_ADDRESS: "0xbede0Ae1a6043c056600eeED0d561dE9771Ef863", //base
    WSSQUID_ADDRESS: "0xE428C32Fe2dFDE4E25e9bB37C690Ce22229F21AC", //base

    // DAI_ADDRESS: "0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2", // weth on mainnet
    STAKING_ADDRESS: "0x6F82D82e6FEcB6d0dAF08b8fFD9772d596582F4A", // The new staking contract TODO confirm what old and new means  base
    STAKING_HELPER_ADDRESS: "0x14d4bd92D17C9510f0629cf69b7Fccf0A621e6B8", // Helper contract used for Staking only  TODO is this for new or old base added dunks
    // OLD_STAKING_ADDRESS: "0x6F82D82e6FEcB6d0dAF08b8fFD9772d596582F4A", // added same staking as above dunks base
    // OLD_SSQUID_ADDRESS: "0x3347453Ced85bd288D783d85cDEC9b01Ab90f9D8",
    // PRESALE_ADDRESS: "0xcBb60264fe0AC96B0EFa0145A9709A825afa17D8", // TODO study presale contract  NOT BASE
    // AOHM_ADDRESS: "0x24ecfd535675f36ba1ab9c5d39b50dc097b0792e", // idk what this is
    // MIGRATE_ADDRESS: "0xC7f56EC779cB9e60afA116d73F3708761197dB3d", // idk what this is
    DISTRIBUTOR_ADDRESS: "0xEAE08f7012396bb395bA9ca2EcD9F4238395E261", // base
    BONDINGCALC_ADDRESS: "0x2dEE203162C6A2573d50ada473176AAB99247873", // base
    // CIRCULATING_SUPPLY_ADDRESS: "0x0efff9199aa1ac3c3e34e957567c1be8bf295034", // we dont have this
    TREASURY_ADDRESS: "0x68d91Bb4b1760Bc131555D23a438585D937A8e6d", // base
    REDEEM_HELPER_ADDRESS: "0x4D190266ff4A9e8362c40ce4ad7f59b20a1828cB", // base
  },
};
